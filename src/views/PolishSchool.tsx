      ...
      <StyledContainer>
        ...
        <StyledContent>
          <FileLink
            ...
            fileLink="/znpu-react/Intehr.kurs.polskoyi.ta.zarub.lit.5-9-kl.Lebed.14.07.pdf"
          ...
          <FileLink
            isFileDownload={false}
            fileLink="/znpu-react/literatura-polska-ta-zarubizhna-dlya-zagalnoosvitnix-navchalnix-zaklladiv-z-navchannyam-polskoyu-movoyu.pdf"
          ...
          <FileLink
            isFileDownload={false}
            fileLink="/znpu-react/polska-mova-dlya-zagalnoosvitnix-navchalnix-zakladiv-z-navchannyam-polskoyu-movoyu.pdf"
            title="ПОЛЬСЬКА МОВА. ПРОГРАМА для загальноосвітніх навчальних закладів з навчанням польською мовою 5 –9 КЛАСИ"
          />
          <FileLink
            isFileDownload={false}
            fileLink="/znpu-react/polska-mova-dlya-zagalnoosvitnix-navchalnix-zakladiv-z-navchannyam-polskoyu-movoyu-profilnij-riven_1.pdf"
          ...
          <FileLink
            isFileDownload={false}
            fileLink="/znpu-react/5-6__10-11______.pdf"
          ...
          <FileLink
            isFileDownload={false}
            fileLink="/znpu-react/historiaPolski5-11.pdf"
          ...
          <FileLink
            isFileDownload={false}
            fileLink="/znpu-react/polska-literatura-dlya-zagalnoosvitnix-navchalnix-zakladiv-z-navchannyam-polskoyu-movoyu-profilnij-riven.doc"
          ...
          <FileLink
            isFileDownload={false}
            fileLink="/znpu-react/polska-mova-ta-literatura-z-navchannyam-polskoyu-movoyu-riven-standartu.docx"
          ...
          <FileLink
            isFileDownload={false}
            fileLink="/znpu-react/Пол. мова 1-2 кл. шк. з пол. мовою навчання.doc"
          ...
          <FileLink
            isFileDownload={false}
            fileLink="/znpu-react/Пол.мова3-4кл.шк.зпольськоюмовоюнавчання2018..doc"
